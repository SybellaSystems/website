...
export default function Sidebar() {
  ...
  const menuItems: {
  ...
  }[] = [
    {
      ...
      roles: ["executive", "manager", "accountant", "sales", "marketing", "qa-tester", "superadmin", "cto"],
    },
    { name: "Contacts", href: "/admin/contacts", icon: Phone, roles: ["executive", "marketing", "superadmin", "cto"] },
    {
      name: "Blogs",
      icon: FileText,
    ...
    { name: "Users", href: "/admin/users", icon: Users, roles: ["executive", "superadmin"] },
    {
      name: "Staff",
      icon: UserCog,
    ...
    { name: "Accounts", href: "/admin/accounts", icon: DollarSign, roles: ["accountant", "superadmin"] },
    { name: "Sales", href: "/admin/sales", icon: DollarSign, roles: ["sales", "superadmin"] },
  ];
