...
values
  ('team-management', 'Team Management', 'Manage accounts, org chart and supervision structures.', 'hr-manager'),
  ('hr-dashboard', 'HR Dashboard', 'Track employee lifecycle and people operations metrics.', 'hr-manager'),
  ('employee-profiles', 'Employee Profiles', 'Centralized employee records and performance context.', 'hr-manager'),
  ('tasks', 'Tasks', 'Coordinate execution workload across teams.', 'manager'),
  ('projects-management', 'Projects Management', 'Manage portfolio, assignment and delivery risk.', 'project-manager'),
  ('financial-dashboard', 'Financial Dashboard', 'Monitor financial performance and budgets.', 'finance-manager'),
  ('sales-analytics', 'Sales Analytics', 'Track pipeline conversion and sales outcomes.', 'sales'),
  ('marketing-campaigns', 'Marketing Campaigns', 'Run campaign operations and attribution flows.', 'marketing'),
  ('legal-documents', 'Legal Documents', 'Govern legal approvals and compliance artifacts.', 'legal-counsel'),
  ('performance-analytics', 'Performance Analytics', 'Analyze productivity and outcome metrics.', 'business-analyst'),
  ('notifications-center', 'Notifications Center', 'Company-wide notification workflows and triage.', 'manager'),
  ('internal-messaging', 'Internal Messaging', 'Operational communication and threaded collaboration.', 'manager'),
  ('meetings-scheduling', 'Meetings & Scheduling', 'Plan meetings and ownership agendas.', 'operations-manager'),
  ('permissions-manager', 'Permissions Manager', 'Manage RBAC roles, grants and exception rules.', 'superadmin'),
  ('activity-monitoring', 'Activity Monitoring', 'Observe system actions and user events.', 'executive'),
  ('recruitment-pipeline', 'Recruitment Pipeline', 'Handle candidate workflows and hiring stages.', 'recruiter'),
  ('support-tickets', 'Support Tickets', 'Customer issue intake, escalation and closure.', 'customer-support'),
  ('content-management', 'Content Management', 'Plan and publish content operations.', 'content-manager'),
  ('product-roadmap', 'Product Roadmap', 'Drive roadmap planning and milestone priorities.', 'product-manager'),
  ('qa-workflows', 'QA Workflows', 'Manage QA plans, defects and verification outcomes.', 'qa-tester'),
